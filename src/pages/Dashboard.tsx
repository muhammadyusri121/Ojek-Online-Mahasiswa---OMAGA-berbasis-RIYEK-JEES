        ...
        <div className="relative bg-green-600 text-white p-8 rounded-2xl shadow-lg overflow-hidden mb-8 flex flex-col md:flex-row items-center justify-between">
          <div className="z-10">
            ...
            <p className="text-green-100 max-w-md">
              {user?.role === "admin"
                ? "Anda memiliki akses penuh untuk mengelola sistem OMAGA."
                : "Kelola status dan pesanan Anda di sini."}
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {statCards.map((card, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 hover:shadow-lg hover:-translate-y-1 transition-all"
              >
